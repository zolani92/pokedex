export const pokemon_list = [
  ...
  { id: 39, name: "jigglypuff", types: ["fairy", "normal"] },
  { id: 73, name: "tentacruel", types: ["poison", "water"] },
  { id: 21, name: "spearow", types: ["flying", "normal"] },
  ...
  { id: 17, name: "pidgeotto", types: ["flying", "normal"] },
  ...
  { id: 16, name: "pidgey", types: ["flying", "normal"] },
  ...
  { id: 84, name: "doduo", types: ["flying", "normal"] },
  ...
  { id: 79, name: "slowpoke", types: ["psychic", "water"] },
  ...
  { id: 102, name: "exeggcute", types: ["psychic", "grass"] },
